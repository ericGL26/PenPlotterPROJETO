...
void processarGCode(char* comando){
    ...
    // Agora que a struct esta pronta mandamos para a função que mexe os motores
...
void ExecutarComandosRecebidosPeloUGS(const GCodeStruct& structGCode){
    ...
    //falta chamar a funcao que move os servos em algum lugar. 13/06/26
    ...
    movimentoEmExecucao = true; //avisa que o movimento esta sendo executado.
}   